...
const about = {
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "biruk.f632@gmail.com",
    },
    ...
    // {
    //   fieldName: "Ethio-Language",
    //   fieldValue: "Oromo, Amharic",
    // },
            ...
            <TabsContent value="skills" className="w-full">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 xl:gap-[30px]">
                  {skills.skill_lists.map((skill, index) => {
                    return (
                      <li key={index}>
